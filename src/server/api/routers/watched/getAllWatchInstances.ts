import { convertImageHash } from '../utils/convertImageHash';
import { type AuthedTRPCContext, protectedProcedure } from '~/server/api/trpc';

export const getAllWatchInstances = async ({
  ctx,
}: {
...
export const getAllWatchInstancesProcedure =
  protectedProcedure.query(getAllWatchInstances);
