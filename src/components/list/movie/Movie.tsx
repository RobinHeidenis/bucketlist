          ...
          <div className="flex flex-row items-start">
            ...
            <div className="flex h-full flex-col justify-between">
              ...
              <div className="flex flex-col sm:flex sm:flex-row sm:flex-wrap sm:items-center">
                ...
                <FlexRowCenter sx="whitespace-nowrap">
                  <ClockIcon className="mr-1 h-5 w-5 flex-shrink-0 sm:ml-2" />
                ...
                {movie.genres ? (
                  ...
                  >
                    <TagIcon className="mr-1 h-5 w-5 flex-shrink-0 sm:ml-2" />
                  ...
                  <>
                    <TagIcon className="mr-1 h-5 w-5 sm:ml-2" /> none
                  </>
                )}
              </div>
            </div>
